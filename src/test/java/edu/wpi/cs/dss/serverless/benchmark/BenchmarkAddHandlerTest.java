...
public class BenchmarkAddHandlerTest extends LambdaTest {
    ...
    public void testValidAddBenchmark() {
        final BenchmarkAddRequest request = new BenchmarkAddRequest();
    ...
    public void testInvalidBenchmarkAdd() {
        ...
        final BenchmarkAddRequest invalidProblemInstanceIdRequest = new BenchmarkAddRequest();
        ...
        final BenchmarkAddRequest invalidImplementationIdRequest = new BenchmarkAddRequest();
    ...
    private void testInput(BenchmarkAddRequest request) throws IOException {
        final BenchmarkAddHandler handler = new BenchmarkAddHandler();
        final BenchmarkAddResponse response = (BenchmarkAddResponse) handler.handleRequest(
    ...
    private void testFailInput(BenchmarkAddRequest request) throws IOException {
        final BenchmarkAddHandler handler = new BenchmarkAddHandler();
