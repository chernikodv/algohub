...
public class ClassificationRemoveHandlerTest extends LambdaTest {
    ...
    private String addClassification() {
        // add before remove
        final ClassificationAddRequest request = new ClassificationAddRequest();
        ...
        final ClassificationAddResponse response = (ClassificationAddResponse) handler.handleRequest(
