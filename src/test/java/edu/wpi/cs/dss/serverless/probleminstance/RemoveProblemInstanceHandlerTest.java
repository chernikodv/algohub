...
public class RemoveProblemInstanceHandlerTest extends LambdaTest {
    ...
    private String addProblemInstance() {
        // add before remove
        final CreateProblemInstanceRequest addRequest = new CreateProblemInstanceRequest();
        ...
        final CreateProblemInstanceHandler addHandler = new CreateProblemInstanceHandler();
        final CreateProblemInstanceResponse addResponse = (CreateProblemInstanceResponse) addHandler.handleRequest(
    ...
    private void testInput(GenericRemoveRequest request) throws IOException {
        final RemoveProblemInstanceHandler handler = new RemoveProblemInstanceHandler();
