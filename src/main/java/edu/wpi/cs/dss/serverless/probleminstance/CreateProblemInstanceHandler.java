...
public class CreateProblemInstanceHandler implements RequestHandler<CreateProblemInstanceRequest, GenericResponse> {
    ...
    @Override
    public GenericResponse handleRequest(CreateProblemInstanceRequest request, Context context) {
    ...
    private GenericResponse saveProblemInstanceDataset(CreateProblemInstanceRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            return CreateProblemInstanceResponse.builder()
