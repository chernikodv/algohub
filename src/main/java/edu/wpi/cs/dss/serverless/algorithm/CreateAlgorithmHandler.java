...
public class CreateAlgorithmHandler implements RequestHandler<CreateAlgorithmRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(CreateAlgorithmRequest request, Context context) {
    ...
    private GenericResponse save(CreateAlgorithmRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            return CreateAlgorithmResponse.builder()
