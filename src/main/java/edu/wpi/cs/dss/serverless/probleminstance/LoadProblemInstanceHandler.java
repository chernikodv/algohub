...
public class LoadProblemInstanceHandler implements RequestHandler<LoadProblemInstanceRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(LoadProblemInstanceRequest request, Context context) {
    ...
    private GenericResponse getProblemInstanceById(LoadProblemInstanceRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            try (final ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    return LoadProblemInstanceResponse.builder()
