...
public class CreateBenchmarkHandler implements RequestHandler<CreateBenchmarkRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(CreateBenchmarkRequest request, Context context) {
    ...
    private GenericResponse save(CreateBenchmarkRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            return CreateBenchmarkResponse.builder()
