...
import edu.wpi.cs.dss.serverless.user.http.LoadUsersRequest;
import edu.wpi.cs.dss.serverless.user.http.LoadUsersResponse;
...
public class LoadUsersHandler implements RequestHandler<LoadUsersRequest, GenericResponse> {
    ...
    @Override
    public GenericResponse handleRequest(LoadUsersRequest request, Context context) {
    ...
    private GenericResponse getAllUsers() {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            return LoadUsersResponse.builder()
