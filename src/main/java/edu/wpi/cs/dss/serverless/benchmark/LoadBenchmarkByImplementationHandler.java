...
import edu.wpi.cs.dss.serverless.benchmark.model.Benchmark;
...
public class LoadBenchmarkByImplementationHandler implements RequestHandler<LoadBenchmarkByImplementationRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(LoadBenchmarkByImplementationRequest request, Context context) {
    ...
    private GenericResponse findById(LoadBenchmarkByImplementationRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            try (final ResultSet resultSet = preparedStatement.executeQuery()) {
                ...
                return LoadBenchmarkByImplementationResponse.builder()
