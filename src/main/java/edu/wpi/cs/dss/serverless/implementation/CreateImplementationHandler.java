...
import edu.wpi.cs.dss.serverless.implementation.http.LoadImplementationResponse;
...
public class CreateImplementationHandler implements RequestHandler<LoadImplementationRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(LoadImplementationRequest request, Context context) {
    ...
    private GenericResponse findById(LoadImplementationRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            try (final ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    return LoadImplementationResponse.builder()
