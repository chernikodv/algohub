...
import edu.wpi.cs.dss.serverless.user.http.RemoveUserDataRequest;
...
public class RemoveUserDataHandler implements RequestHandler<RemoveUserDataRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(RemoveUserDataRequest request, Context context) {
    ...
    private GenericResponse removeData(RemoveUserDataRequest request) {
