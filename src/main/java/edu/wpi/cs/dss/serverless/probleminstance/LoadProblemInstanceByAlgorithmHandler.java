...
public class LoadProblemInstanceByAlgorithmHandler implements RequestHandler<LoadProblemInstanceByAlgorithmRequest, GenericResponse> {

    private LambdaLogger logger;

    @Override
    public GenericResponse handleRequest(LoadProblemInstanceByAlgorithmRequest request, Context context) {
    ...
    private GenericResponse getProblemInstanceByAlgorithmId(LoadProblemInstanceByAlgorithmRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            try (final ResultSet resultSet = preparedStatement.executeQuery()) {
                ...
                return LoadProblemInstanceByAlgorithmResponse.builder()
