...
public class LoadImplementationHandler implements RequestHandler<CreateImplementationRequest, GenericResponse> {
    ...
    @Override
    public GenericResponse handleRequest(CreateImplementationRequest request, Context context) {
    ...
    private GenericResponse save(CreateImplementationRequest request) {
        ...
        try (final Connection connection = DataSource.getConnection(logger);
            ...
            return CreateImplementationResponse.builder()
    ...
    private String generateFilename(String id, CreateImplementationRequest request) {
